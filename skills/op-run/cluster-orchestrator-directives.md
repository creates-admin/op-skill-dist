...
```bash
# gh channel: 通常の label add
op issue edit-labels "$PR_NUMBER" --add "auto-fix"
...
op issue edit-labels "$PR_NUMBER" --add "auto-fix" --input-json "<fresh search_pull_requests item>"
```
