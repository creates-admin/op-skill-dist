...
本 templates は review-expert が PR コメントを生成する際の作業用複製で、field schema は
`markers/review-markers.md`、テンプレ形は `pr-templates.md` を必ず正とする。
...
- needs-fix / needs-specialist-review / blocked では **各 finding に `<!-- op-review-finding -->` block を必ず付ける**
